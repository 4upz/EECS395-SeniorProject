...
{
    [SerializeField] private Interactable interactable;     // References the script controlling object interactions/sounds
    ...
    public void nextPuzzle(){
        ...
        if (activePuzzleIndex < puzzles.Length-1){
            ...
            setGoalInteractable(currentGoalObject);
            riddleDisplay.text = $"Object #{activePuzzleIndex+1}:\n{puzzles[activePuzzleIndex].riddle}";
            // Allows the interactable script to track the current puzzle
            Interactable.currentPuzzle = activePuzzleIndex;
        }
        else {
